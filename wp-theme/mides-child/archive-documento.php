<?php
/**
 * Archive template for CPT 'documento' — renderiza /documentos/
 */
...
<section class="contacto-hero">
  ...
  <div class="container contacto-hero__content">
    <h1 class="contacto-hero__title">Documentos</h1>
    <img src="<?php echo esc_url( $linea_svg ); ?>" alt="" class="contacto-hero__line" />
    <?php
    $subtitulo = 'Publicaciones y documentos oficiales del MIDES';
    ?>
