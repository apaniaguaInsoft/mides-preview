    ...
    <div class="mesas-tecnicas__grid">
      ...
      <div class="mesa-card">
        ...
        <div class="mesa-card__body">
          ...
          <span class="mesa-card__rectora">Entidad rectora: <strong><?php echo esc_html( $mesa['rectora'] ?? '' ); ?></strong></span>
    ...
    <div class="mesas-tecnicas__actions">
      ...
      <a href="<?php echo esc_url( $url_ordinarias ); ?>" class="mesas-btn">
        ...
        <span class="mesas-btn__text">
          <strong>Reuniones Ordinarias</strong>
          <span>Ver galería de sesiones</span>
        </span>
        <?php echo $svg_arrow; ?>
      </a>
      <?php endif; ?>
      ...
      <a href="<?php echo esc_url( $url_extraordinarias ); ?>" class="mesas-btn mesas-btn--alt">
        ...
        <span class="mesas-btn__text">
          <strong>Reuniones Extraordinarias</strong>
          <span>Ver galería de sesiones</span>
        </span>
        <?php echo $svg_arrow; ?>
      </a>
