<?php
/**
 * Template Name: MIDES Documentos
...
/* ── Íconos SVG según color ── */
$icon_svgs = [
	'blue'  => '<svg class="doc-card__icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg>',
	'teal'  => '<svg class="doc-card__icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/><polyline points="8 17 10 19 16 13"/></svg>',
	'amber' => '<svg class="doc-card__icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 11 12 14 22 4"/><path d="M21 12v7a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h11"/></svg>',
	'gray'  => '<svg class="doc-card__icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 7V5a2 2 0 00-2-2h-4a2 2 0 00-2 2v2"/></svg>',
];
...
<section class="contacto-hero">
  ...
  <div class="container contacto-hero__content">
    ...
    <?php
    $subtitulo = get_post_meta( get_the_ID(), '_docs_subtitulo', true ) ?: 'Publicaciones y documentos oficiales del MIDES';
    ?>
  ...
  <div class="container">
    ...
    <div class="news-search-wrap">
      <div class="news-search">
        ...
        <input type="text" id="docs-search-input" placeholder="Buscar documentos…" class="news-search__input" autocomplete="off" />
        <button class="news-search__clear" id="docs-search-clear" aria-label="Limpiar búsqueda" style="display:none;">
    ...
    <div class="news-filters" id="docs-filters">
    ...
    <div class="docs-grid" id="docs-grid">
      <?php if ( empty( $documentos ) ) : ?>
        <p style="color:#94A3B8;grid-column:1/-1;text-align:center;padding:64px 0">
      ...
      <?php else : ?>
        <?php foreach ( $documentos as $doc ) :
          ...
          $color      = get_post_meta( $doc_id, '_doc_color',        true ) ?: 'blue';
          ...
          $data_title = mb_strtolower( $titulo_doc );
          $icon_svg   = $icon_svgs[ $color ] ?? $icon_svgs['blue'];
        ?>
        <article class="doc-card"
                 data-category="<?php echo esc_attr( $data_cat ); ?>"
                 data-title="<?php echo esc_attr( $data_title ); ?>">
          <div class="doc-card__header doc-card__header--<?php echo esc_attr( $color ); ?>">
            <?php echo $icon_svg; ?>
    ...
    <!-- Paginación -->
    <div class="news-pagination" id="docs-pagination"></div>
...
(function () {
  ...
  var filters     = document.querySelectorAll('#docs-filters .news-filter');
  var allCards    = Array.from(document.querySelectorAll('#docs-grid .doc-card'));
  var emptyMsg    = document.getElementById('docs-empty');
  ...
  function renderPagination(total) {
    ...
    pagination.querySelectorAll('.news-page').forEach(function (btn) {
      btn.addEventListener('click', function () {
        ...
        renderPage();
        document.querySelector('.docs-section').scrollIntoView({ behavior: 'smooth', block: 'start' });
      });
    });
  }
